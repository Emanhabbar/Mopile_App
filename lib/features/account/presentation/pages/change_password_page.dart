                ...
                children: [
                  TextFormField(
                    ...
                    validator: (value) => (value?.isEmpty ?? true)
                        ? l10n.changePasswordCurrentRequired
                        : null,
                  ),
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      ...
                      if (length < 8) return l10n.changePasswordMinLength;
                      if (length > 128) return l10n.changePasswordMaxLength;
                      return null;
                    },
                  ),
                  const SizedBox(height: 12),
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(AppLocalizations.of(context).changePasswordDone),
        ),
      );
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  l10n.changePasswordHeroSubtitle,
                  style: const TextStyle(
