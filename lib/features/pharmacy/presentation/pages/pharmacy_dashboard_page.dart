  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return state.when(
      loading: () => AppLoadingState(
        label: l10n.dashboardPreparingPharmacy,
      ),
                ...
                children: [
                  ...
                  AppReveal(
                    ...
                    child: _ReadinessCard(
                      data: data,
                      onLocation: () =>
                          context.push('/pharmacy/profile'),
                      onHours: () =>
                          context.push('/pharmacy/working-hours'),
                      onInventory: () =>
...
class _PharmacyHero extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isOpen =
        openStatus?.isOpenNow ?? data.isOpenNow;

    final status =
        openStatus?.statusText.isNotEmpty == true
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              // 🟠 شريط التقدم بنفس لون التحذيرات
              color: context.appColors.warning,
            ),
          ),
          ...
          child: Row(
            children: [
              ...
              Icon(
                ...
                // 🟠 نفس لون التحذيرات للخطوات المكتملة
                color: complete
...
class _InventoryAlertCard
  ...
  Widget build(BuildContext context) {
    ...
    final expiring = alert.alertType
        .toLowerCase()
        .contains('expir');
                  ...
                  children: [
                    ...
                    Text(
                      alert.daysUntilExpiry ==
                              null
                          ? l10n
                              .inventoryAlertLowStock(
                              alert.quantity,
                              alert.lowStockThreshold,
                            )
                          : l10n
                              .inventoryAlertExpiry(
                              alert
                                  .daysUntilExpiry!,
                            ),
                      style: Theme.of(context)
